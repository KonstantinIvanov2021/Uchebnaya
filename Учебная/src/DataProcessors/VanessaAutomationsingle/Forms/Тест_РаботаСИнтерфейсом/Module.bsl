...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюНаКнопкуСЗаголовкомИИменем(Парам01,Парам02)","ЯНажимаюНаКнопкуСЗаголовкомИИменем","И я нажимаю на кнопку с заголовком ""ЗаголовокКнопки"" и именем ""ИмяКнопки""","Нажимает на кнопку с нужным заголовком и именем. Шаг используется, когда надо найти кнопку почасти заголовка и части имени.","UI.Формы.Кнопки");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюСодержимоеФайлаВПеременную(Парам01,Парам02)","ЯЗапоминаюСодержимоеФайлаВПеременную","И я запоминаю содержимое файла ""ИмяФайла"" в переменную ""ИмяПеременной""","Запоминает значение файла в переменную. Можно передавать только имя файла, тогда файл будет искаться рядом с фичей и в каталоге проекта.","Файлы");
